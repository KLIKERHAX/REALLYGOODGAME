...
public class ContinousMovement : MonoBehaviour
{
    ...
    private bool stepWalkSoundIsPlaying;
    ...
    IEnumerator Walk()
    {
        if (stepWalkSoundIsPlaying)
            yield break;

        stepWalkSoundIsPlaying = true;
        stepWalk.pitch = Random.Range(0.7f, 1.3f);
        stepWalk.Play();
        yield return new WaitForSeconds(0.1f);
        stepWalk.Stop();
        yield return new WaitForSeconds(0.3f);

        stepWalkSoundIsPlaying = false;
    }
